...
class TesteUtils(unittest.TestCase):
    def test_traducao_acordes(self):
        ...
        unicos, tonicas, baixos, modos = obter_novos_unicos_tonicas_baixos_modos(seq_notas)
        unicos2, tonicas2, baixos2, modos2 = obter_novos_unicos_tonicas_baixos_modos(seq_notas, 2)
